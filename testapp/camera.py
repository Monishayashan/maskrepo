...
class VideoCamera(object):
    ...
    def get_frame(self):
       ...
       #extracting frames
        ...
        return jpeg.tobytes()
        '''
        net_mask = cv2.dnn.readNet("C://intern//obj//opencv_proj//uploads//yolov3_mask_last.weights", "C://intern//obj//opencv_proj//uploads//yolov3_mask.cfg")
        classes_mask = []
        with open("C://intern//obj//opencv_proj//uploads//coco -1.names", "r") as f:
